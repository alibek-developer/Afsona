      ...
      <div className='max-w-7xl mx-auto px-4'>
          ...
          <div className='overflow-visible' ref={emblaRef}>
            <div className='flex touch-pan-y'>
              {carouselImages.map((src, index) => (
                <div className='flex-[0_0_85%] md:flex-[0_0_60%] min-w-0 pl-8' key={index}>
                  <div
                  ...
                  >
                    <Image src={src} alt='Interior' fill className='object-cover' />
          ...
          <div className='space-y-10 order-1 lg:order-2'>
            <div className='space-y-6'>
              ...
              <p className='text-slate-600 dark:text-slate-400 text-xl leading-relaxed font-medium max-w-xl'>
                Afsona Oshxonasi 2010-yildan buyon haqiqiy mehmondorchilikni ulashib kelmoqda. Har bir taomimizda ota-bobolarimiz siri va cheksiz mehr bor.
              </p>
            </div>

            <div className='flex gap-12'>
              <div>
                <h4 className='font-black text-5xl text-slate-900 dark:text-white italic'>15<span className='text-red-600'>+</span></h4>
              ...
              <div>
                <h4 className='font-black text-5xl text-slate-900 dark:text-white italic'>50<span className='text-red-600'>+</span></h4>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-40'>
          {[
            ...
            <div key={idx} className='group relative p-[1px] rounded-[2.5rem] bg-slate-200 dark:bg-slate-800 hover:bg-red-600 transition-all duration-500 overflow-hidden shadow-sm hover:shadow-xl'>
                <div className='bg-white dark:bg-[#0f172a] p-10 rounded-[2.45rem] h-full flex flex-col items-center text-center'>
                    ...
                    <h3 className='font-black text-xl text-slate-900 dark:text-white uppercase tracking-tighter mb-2'>{item.title}</h3>
                    <p className='text-red-600 dark:text-red-500 font-black text-lg'>{item.desc}</p>
                    <p className='text-slate-500 dark:text-slate-600 text-[10px] uppercase mt-4 font-black tracking-[0.2em]'>{item.label}</p>
                </div>
            </div>
          ))}
        </div>
        ...
        <div className='relative group overflow-hidden bg-red-600 rounded-[4rem] p-12 md:p-24 text-center shadow-[0_20px_80px_rgba(220,38,38,0.3)]'>
          ...
          <h2 className='relative text-5xl md:text-7xl font-black uppercase text-white mb-16 italic tracking-tighter leading-tight'>
          ...
          <div className='relative grid grid-cols-1 md:grid-cols-3 gap-16'>
            {[
              ...
              <div key={fidx} className='space-y-6 group/item'>
                ...
                <p className='text-red-50/80 text-sm font-medium leading-relaxed'>{feature.desc}</p>
              </div>
            ))}
          </div>
          
          <button className='mt-20 group inline-flex items-center gap-3 bg-slate-900 dark:bg-white text-white dark:text-[#020617] px-10 py-5 rounded-2xl font-black uppercase tracking-widest hover:scale-105 transition-all active:scale-95 shadow-2xl'>
