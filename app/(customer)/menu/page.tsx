...
function MenuContent() {
  ...
  // Pagination uchun yangi statelar
  ...
  useEffect(() => {
    ...
    setCurrentPage(1) // Kategoriya o'zgarganda 1-sahifaga qaytish
  }, [searchParams])
    ...
    <div className='max-w-[1300px] mx-auto px-4 md:px-8 space-y-12'>
      ...
      {currentDisplayedItems.length === 0 ? (
        <div className='flex items-center justify-center py-20'>
          <div className='text-center bg-gradient-to-br from-gray-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 rounded-[40px] border-2 border-dashed border-gray-200 dark:border-slate-700 shadow-sm px-8 py-16 max-w-2xl'>
            ...
            <p className='text-gray-400 dark:text-slate-500 font-bold text-lg mb-2'>Taomlar topilmadi</p>
          </div>
        </div>
      ) : (
          ...
          {totalPages > 1 && (
            <div className='flex items-center justify-center gap-3 pt-8 pb-4'>
              <button
                ...
                className='p-2 rounded-xl border border-gray-200 dark:border-slate-800 disabled:opacity-30 hover:bg-gray-50 dark:hover:bg-slate-900 transition-colors'
              >
                  ...
                  <button
                    ...
                    className={`w-10 h-10 rounded-xl font-bold text-sm transition-all ${
                      currentPage === i + 1
                        ...
                        : 'bg-gray-50 dark:bg-slate-900 text-gray-600 dark:text-slate-400 hover:bg-gray-100'
                    }`}
                  >
                    {i + 1}
                  </button>
