	...
	return (
		<>
			...
			<section className='py-20 bg-white relative overflow-hidden'>
				...
				<div className='absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/2 w-64 h-64 bg-slate-50 rounded-full blur-3xl opacity-50' />
					...
					<div className='bg-slate-50 rounded-[3rem] p-8 md:p-16 border border-slate-100 shadow-sm'>
						<div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
							...
							<div className='space-y-8'>
								<div className='space-y-4'>
									...
									<h2 className='text-4xl md:text-5xl font-black text-slate-900 uppercase tracking-tighter leading-none'>
										Buyurtma berish <br />{' '}
										<span className='text-red-600'>yanada oson!</span>
									</h2>
								...
								{/* Yuklab olish tugmasi (Android APK) */}
								<div className='pt-4'>
									<a
										href='/app-release.apk' // APK faylingiz yo'li (public papkasida bo'lishi kerak)
										download
										className='group relative inline-flex items-center gap-4 bg-slate-900 text-white px-8 py-5 rounded-2xl transition-all duration-300 hover:bg-red-600 hover:shadow-2xl hover:shadow-red-200 active:scale-95'
									>
										...
										<div className='text-left'>
											<p className='text-[10px] uppercase font-bold tracking-widest opacity-60 leading-none mb-1'>
												Yuklab olish
											</p>
							...
							<div className='relative hidden lg:flex justify-center'>
								...
								{/* Bezovchi elementlar */}
								<div className='absolute -bottom-6 -right-6 w-32 h-32 bg-red-600 rounded-3xl -z-10 rotate-12 flex items-center justify-center text-white font-black text-2xl'>
									-20%
								</div>
							</div>
						</div>
