...
export default function AdminLayout({
	...
	// Mavzuni localStorage-dan yuklash va tizimga moslash
	useEffect(() => {
					...
					return (
						<Link
							...
							className={cn(
								...
								isActive
									? 'bg-red-600 text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.1)]'
									: 'text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-red-600 dark:hover:text-red-400',
							)}
						>
							<item.icon
								className={cn(
			...
			<div className='p-6 border-t border-slate-100 dark:border-slate-800/50 space-y-2'>
				...
				>
					{darkMode ? (
						...
						<Moon className='h-5 w-5 mr-3 text-slate-600' />
					)}
	...
	return (
		<div className='min-h-screen bg-slate-50 dark:bg-[#020617] flex transition-colors duration-300 text-slate-900 dark:text-slate-100'>
			{/* Desktop Sidebar */}
			...
			<main className='flex-1 flex flex-col min-w-0'>
				{/* Mobile Header */}
				<div className='md:hidden h-20 bg-white dark:bg-[#0f172a] border-b border-slate-200 dark:border-slate-800 px-6 flex items-center justify-between z-40 sticky top-0'>
