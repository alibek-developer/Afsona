...
export function CartSidebar() {
	...
	if (items.length === 0) {
		return (
			<div className='flex flex-col h-full bg-white dark:bg-[#0b1120] text-slate-900 dark:text-white transition-colors'>
				<SheetHeader className='border-b border-slate-200 dark:border-white/5 p-5'>
					<SheetTitle className='text-xl font-black uppercase tracking-normal text-slate-900 dark:text-white'>
						Savatcha
					</SheetTitle>
					<SheetDescription className='text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-[2px]'>
						Hozircha bo'sh
					</SheetDescription>
				</SheetHeader>
	...
	return (
		<div className='flex flex-col h-full bg-white dark:bg-[#0b1120] transition-colors'>
			{/* Header */}
			<SheetHeader className='border-b border-slate-200 dark:border-white/5 p-5 bg-white dark:bg-[#0b1120] z-10'>
			...
			<div className='flex-1 overflow-y-auto py-6 px-4 custom-scrollbar bg-white dark:bg-[#0b1120]'>
					...
					<AnimatePresence mode='popLayout'>
						{items.map(item => (
							<motion.div
								...
								className='flex gap-4 p-4 bg-slate-50 dark:bg-[#161f32] rounded-2xl border border-slate-200 dark:border-white/5 shadow-2xl relative group'
							>
								<div className='relative w-20 h-20 rounded-xl overflow-hidden flex-shrink-0 border border-slate-200 dark:border-white/10'>
									<Image
								...
								<div className='flex-1 min-w-0 flex flex-col justify-between py-1'>
									...
									<div className='flex items-center justify-between'>
										...
										<div className='flex items-center gap-3 bg-white dark:bg-[#0b1120] rounded-xl border border-slate-200 dark:border-white/10 p-1'>
											<button
			...
			<div className='border-t border-slate-200 dark:border-white/5 p-6 bg-white dark:bg-[#0b1120] space-y-5'>
