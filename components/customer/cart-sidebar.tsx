    ...
    return (
      <div className='flex flex-col h-full bg-[#0b1120] text-white'>
        <SheetHeader className='border-b border-white/5 p-5'>
          ...
          <SheetDescription className='text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em]'>
            Hozircha bo'sh
          </SheetDescription>
        </SheetHeader>
        ...
        <div className='flex-1 flex flex-col items-center justify-center p-10'>
          ...
          <SheetClose asChild>
            <Link href='/menu' className="w-full">
              <Button className='w-full h-16 text-sm font-black uppercase tracking-widest bg-red-600 hover:bg-red-700 text-white rounded-2xl border-b-[6px] border-red-900 active:border-b-0 active:translate-y-1 transition-all shadow-2xl shadow-red-900/40'>
                Menyuni ko'rish
              </Button>
            </Link>
          </SheetClose>
    ...
    <div className='flex flex-col h-full bg-[#0b1120]'>
      ...
      <div className='border-t border-white/5 p-6 bg-[#0b1120] space-y-5'>
        ...
        <SheetClose asChild>
          <Link href='/checkout'>
            <Button
              className='w-full h-15 text-sm font-black rounded-xl bg-red-600 hover:bg-red-700 text-white shadow-xl shadow-red-900/10 active:scale-[0.98] transition-all uppercase flex items-center justify-center gap-3 group'
            >
              Rasmiylashtirish
