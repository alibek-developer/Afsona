...
export function HeroSection() {
  ...
  return (
    <section ref={containerRef} className='relative min-h-screen w-full flex items-center justify-center bg-white dark:bg-[#020617] overflow-hidden py-20'>
      
      {/* 1. DINAMIK FON ELEMLARI (Premium vibe) */}
      <div className='absolute inset-0 pointer-events-none'>
        <motion.div style={{ y: y1 }} className='absolute top-[10%] left-[5%] w-[400px] h-[400px] bg-red-600/5 blur-[100px] rounded-full' />
        <motion.div style={{ y: y2 }} className='absolute bottom-[10%] right-[5%] w-[300px] h-[300px] bg-blue-600/5 blur-[100px] rounded-full' />
      ...
      <div className='relative z-10 w-full max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
        ...
        <div className='text-left space-y-8'>
          ...
          >
            ...
            <span className='text-[10px] font-black uppercase tracking-[0.2em] text-red-600'>Eng sara restoran 2024</span>
          </motion.div>
          ...
          >
            <h1 className='text-6xl md:text-8xl font-black uppercase tracking-[-0.04em] leading-[0.9]'>
              <span className='text-slate-900 dark:text-white'>Haqiqiy</span> <br />
          ...
          >
            Milliy an'analar va zamonaviy gastronomiyaning uyg'unligi. 
            Siz uchun eng sara masalliqlardan tayyorlangan o'zbekona shohona taomlar.
          </motion.p>
          ...
          >
             <div className='flex flex-col gap-1'>
                <span className='text-2xl font-black text-slate-900 dark:text-white'>30+</span>
                <span className='text-[10px] font-bold uppercase tracking-widest text-slate-500'>Turli taomlar</span>
             </div>
             <div className='flex flex-col gap-1'>
                <span className='text-2xl font-black text-slate-900 dark:text-white'>4.9</span>
                <span className='text-[10px] font-bold uppercase tracking-widest text-slate-500'>Mijozlar reytingi</span>
             </div>
             <div className='flex flex-col gap-1'>
                <span className='text-2xl font-black text-slate-900 dark:text-white'>24/7</span>
                <span className='text-[10px] font-bold uppercase tracking-widest text-slate-500'>Yetkazib berish</span>
             </div>
          </motion.div>
        </div>
          ...
          <div className='relative w-[500px] h-[500px] mx-auto'>
            ...
            >
               <div className='flex items-center gap-3'>
                  ...
                  <div>
                    <p className='text-xs font-black dark:text-white uppercase'>Tezkor</p>
                    <p className='text-[10px] text-slate-500 uppercase'>Yetkazib berish</p>
                  </div>
               </div>
            </motion.div>
          </div>
